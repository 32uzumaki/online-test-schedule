...
# ファイルパス
equipment_schedule_path = "ジュール.csv"
...
pivot_table = pivot_table.reindex(columns=date_columns + ['搬入日未定'], fill_value='')

# CSVファイルに保存
pivot_table.to_csv('test_schedule_pivot_with_undecided.csv', encoding='utf-8-sig')
